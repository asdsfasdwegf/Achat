...
class PostDetailView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'home/detail.html', {'post': self.post_instance,'comment':comments,'form':self.form_class,'reply_form':self.form_class_reply})
...
class PostUpdateView(LoginRequiredMixin, View):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if post.user.id != request.user.id:
            messages.error(request, 'you cant this post' , 'danger')
            return redirect('home:home')
...
class PostAddRepyView(LoginRequiredMixin, View):
